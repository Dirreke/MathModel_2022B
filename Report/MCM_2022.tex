...
而每个非空栈当且仅当出现在一个条带中
\begin{equation}
    \sum_{k=1}^{n} b_{k,j}=\sum_{k=1}^{j} b_{k,j}=
    \begin{cases}
        1, \quad  & Stack_j \notin  \phi  \\
        0,\quad  & Stack_j  \in  \phi  \\
    \end{cases}
...
\begin{equation}
    \sum_{l=1}^{n} r_{l,k}=\sum_{l=1}^{k} r_{l,k}=
    \begin{cases}
        1, \quad  & Stripe_k \notin  \phi  \\
        0,\quad  & Stripe_k \in  \phi  \\
    \end{cases}
